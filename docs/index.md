...
<html lang="ru">
<head>
    <!-- ⬇️ НАЧАЛО: Сюда вставляем CSS-стили ⬇️ -->
    <style>
        body {
    ...
    <!-- ⬆️ КОНЕЦ: Стили вставили ⬆️ -->

    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Евгений Свиркович - Резюме</title>
</head>
<body>

    <!-- ⬇️ НАЧАЛО: Сюда вставляем СОДЕРЖАНИЕ резюме ⬇️ -->
    <h1>Евгений Свиркович</h1>
    <p><strong>Системный администратор | DevOps-инженер</strong></p>
    <hr>

    <h2>Обо мне</h2>
    <p>Системный администратор с более 12 лет опыта поддержки IT-инфраструктуры. Специализируюсь на администрировании Linux/Windows, сетевой безопасности и автоматизации рутинных задач. Ищу возможность применения своих навыков в динамичной компании.</p>
    ...
    <h2>Опыт работы</h2>
    <h3>Системный администратор | ООО "IntexSoft"</h3>
    <p><em>Февраль 2022 - Настоящее время</em></p>
    <ul>
    ...
    <h3>Системный администратор | Гос Организация"</h3>
    <p><em>Июнь 2014 - Февраль 2022</em></p>
    <ul>
    ...
    <h2>Контакты</h2>
    <p class="contact">
        Email: evgeny.svir@example.com | Telegram: @evgeny_sys | GitHub: evgenysvirkovich
    </p>
    <!-- ⬆️ КОНЕЦ: Содержание резюме вставили ⬆️ -->
